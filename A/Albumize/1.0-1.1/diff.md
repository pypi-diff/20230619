# Comparing `tmp/Albumize-1.0.tar.gz` & `tmp/Albumize-1.1.tar.gz`
...
## Comparing `Albumize-1.0.tar` & `Albumize-1.1.tar`
...
### Comparing `Albumize-1.0/Albumize.py` & `Albumize-1.1/Albumize.py`
