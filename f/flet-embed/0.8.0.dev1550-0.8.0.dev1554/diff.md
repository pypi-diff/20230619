# Comparing `tmp/flet_embed-0.8.0.dev1550.tar.gz` & `tmp/flet_embed-0.8.0.dev1554.tar.gz`
...
## Comparing `flet_embed-0.8.0.dev1550.tar` & `flet_embed-0.8.0.dev1554.tar`
...
### Comparing `flet_embed-0.8.0.dev1550/pyproject.toml` & `flet_embed-0.8.0.dev1554/pyproject.toml`
...
### Comparing `flet_embed-0.8.0.dev1550/PKG-INFO` & `flet_embed-0.8.0.dev1554/PKG-INFO`
