# Comparing `tmp/pycti-5.8.0.tar.gz` & `tmp/pycti-5.8.1.tar.gz`
...
### Comparing `pycti-5.8.0/pycti/entities/opencti_vulnerability.py` & `pycti-5.8.1/pycti/entities/opencti_vulnerability.py`
