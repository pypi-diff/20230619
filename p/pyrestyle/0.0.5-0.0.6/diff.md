# Comparing `tmp/pyrestyle-0.0.5.tar.gz` & `tmp/pyrestyle-0.0.6.tar.gz`
...
## Comparing `pyrestyle-0.0.5.tar` & `pyrestyle-0.0.6.tar`
...
### Comparing `pyrestyle-0.0.5/LICENSE` & `pyrestyle-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `pyrestyle-0.0.5/PKG-INFO` & `pyrestyle-0.0.6/PKG-INFO`
...
### Comparing `pyrestyle-0.0.5/pyrestyle.egg-info/PKG-INFO` & `pyrestyle-0.0.6/pyrestyle.egg-info/PKG-INFO`
...
### Comparing `pyrestyle-0.0.5/pyrestyle.py` & `pyrestyle-0.0.6/pyrestyle.py`
...
### Comparing `pyrestyle-0.0.5/setup.py` & `pyrestyle-0.0.6/setup.py`
