# Comparing `tmp/syrupy-4.0.2.tar.gz` & `tmp/syrupy-4.0.3.tar.gz`
...
## Comparing `syrupy-4.0.2.tar` & `syrupy-4.0.3.tar`
...
### Comparing `syrupy-4.0.2/LICENSE` & `syrupy-4.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/README.md` & `syrupy-4.0.3/README.md`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/pyproject.toml` & `syrupy-4.0.3/pyproject.toml`
...
### Comparing `syrupy-4.0.2/src/syrupy/__init__.py` & `syrupy-4.0.3/src/syrupy/__init__.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/assertion.py` & `syrupy-4.0.3/src/syrupy/assertion.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/data.py` & `syrupy-4.0.3/src/syrupy/data.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/exceptions.py` & `syrupy-4.0.3/src/syrupy/exceptions.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/amber/__init__.py` & `syrupy-4.0.3/src/syrupy/extensions/amber/__init__.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/amber/serializer.py` & `syrupy-4.0.3/src/syrupy/extensions/amber/serializer.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/base.py` & `syrupy-4.0.3/src/syrupy/extensions/base.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/image.py` & `syrupy-4.0.3/src/syrupy/extensions/image.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/json/__init__.py` & `syrupy-4.0.3/src/syrupy/extensions/json/__init__.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/extensions/single_file.py` & `syrupy-4.0.3/src/syrupy/extensions/single_file.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/filters.py` & `syrupy-4.0.3/src/syrupy/filters.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/location.py` & `syrupy-4.0.3/src/syrupy/location.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/matchers.py` & `syrupy-4.0.3/src/syrupy/matchers.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/report.py` & `syrupy-4.0.3/src/syrupy/report.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/session.py` & `syrupy-4.0.3/src/syrupy/session.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/types.py` & `syrupy-4.0.3/src/syrupy/types.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/src/syrupy/utils.py` & `syrupy-4.0.3/src/syrupy/utils.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.2/setup.py` & `syrupy-4.0.3/setup.py`
...
### Comparing `syrupy-4.0.2/PKG-INFO` & `syrupy-4.0.3/PKG-INFO`
